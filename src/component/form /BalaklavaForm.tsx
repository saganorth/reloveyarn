    ...
    const handleColorCheckbox = (
      ...
      <div className="mb-8">
        ...
        <div className="mb-6">
          ...
          >
            {[
              { value: 'A', label: 'Strings', imgSrc: '/balaklava.png' },
              { value: 'B', label: 'Open Face', imgSrc: '/cotton.png' },
              { value: 'C', label: 'Eyes Only', imgSrc: '/eyes.png' },
              { value: 'D', label: 'Animal Ears', imgSrc: '/muse.png' },
              { value: 'E', label: 'Net Style', imgSrc: '/netbala.png' },
              { value: 'F', label: 'Scrappy', imgSrc: '/scrapybala.png' },
            ].map((bag) => (
              <label
                key={bag.value}
                className="
