    ...
    <main className="bg-violet-200 text-white">
      ...
      <div className="h-screen  bg-cover bg-center" style={{ backgroundImage: "url('filt.jpeg')" }}>
        <div className="flex items-center justify-center h-full">
          <h1 className="text-4xl font-bold text-white">Välkommen till Min Webbshop</h1>
        </div>
      </div>
      ...
      <div className="container mx-auto p-5">
        ...
        <div className="flex justify-around">
          {/* Produktkort */}
          {/* Upprepa dessa kort för varje produkt */}
          <div className="max-w-sm rounded overflow-hidden shadow-lg bg-gray-700">
            <img className="w-full" src="filt.jpeg" alt="Produktbild" />
            <div className="px-6 py-4">
              <div className="font-bold text-xl mb-2">virkad filt</div>
